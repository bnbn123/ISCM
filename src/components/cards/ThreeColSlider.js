...
const TextInfo = tw.div`flex-grow py-6 sm:px-10 sm:py-6`;

const TitleReviewContainer = tw.div`flex flex-col sm:flex-row sm:justify-between sm:items-center`;
const Title = tw.h5`text-2xl font-bold truncate`;
...
const Description = tw.p` flex-grow text-sm leading-loose mt-2 sm:mt-4 break-words overflow-hidden`;
