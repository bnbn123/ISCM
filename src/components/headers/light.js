...
export const NavLinks = tw.ul`inline-block`;
...
export const NavToggle = tw.button`
  lg:hidden z-30 focus:outline-none hocus:text-primary-700 transition duration-300
`;
...
const collapseBreakPointCssMap = {
  sm: {
    mobileNavLinks: tw`sm:hidden z-30`,
